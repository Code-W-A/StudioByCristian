...
const projectDetails = {
  ...
  beforeAfterComparisons: [
    {
      before: "/turn-key-management-amsterdam-apartment-1/Amsterdam-1-Before-Banner-scaled.jpg.jpeg",
      after: "/turn-key-management-amsterdam-apartment-1/Amsterdam-1-After-Banner-scaled.jpg.jpeg",
      alt: "Amsterdam apartment 1 transformation"
    }
  ],
  beforeSection: {
    title: "Before",
    ...
    images: [
      { src: "/turn-key-management-amsterdam-apartment-1/Amsterdam-Appartments-Before-01-1.jpg.jpeg", alt: "Before renovation - Main area" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsterdam-Appartments-Before-02.jpg.jpeg", alt: "Before renovation - Living space" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsterdam-Appartments-Before-03.jpg.jpeg", alt: "Before renovation - Kitchen area" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsterdam-Appartments-Before-04.jpg.jpeg", alt: "Before renovation - Interior view" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsterdam-Appartments-Before-05.jpg.jpeg", alt: "Before renovation - Room details" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsterdam-Appartments-Before-06.jpg.jpeg", alt: "Before renovation - Original state" },
    ]
  },
  inProgressSection: {
    title: "In Progress",
    description: "This Home was ready for a new life. We focused in keeping the original main structure materials such as wood. The house was fully isolated, made in complete wood structure and we also replaced some of the beams of this old house in Amsterdam, that has a history of more than 400 years.",
    images: [
      { src: "/turn-key-management-amsterdam-apartment-1/IMG_7134.jpeg", alt: "Construction in progress - Structural work" },
      { src: "/turn-key-management-amsterdam-apartment-1/IMG_7327.jpeg", alt: "Construction in progress - Wood beams" },
      { src: "/turn-key-management-amsterdam-apartment-1/IMG_7332.jpeg", alt: "Construction in progress - Interior work" },
      { src: "/turn-key-management-amsterdam-apartment-1/IMG_7337.jpeg", alt: "Construction in progress - Renovation" },
      { src: "/turn-key-management-amsterdam-apartment-1/IMG_7340.jpeg", alt: "Construction in progress - Details" },
    ]
  },
  afterSection: {
    title: "After",
    description: "The house's footprint has remained faithful to the original, but the walls have now got a refreshing new look with their light grey modern tone. Joining the scene are the light fixtures in the form of black accents. The kitchen is set up in a functionally optimal layout, with modern, clean shapes and minimalistic details, everything keeping at heart the game of contrasts on the canvas of the warm oak wood flooring.",
    subtitle: "The house's footprint has remained faithful to the original",
    images: [
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-13-1-scaled.jpg.jpeg", alt: "After renovation - Main living area" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-15-1-scaled.jpg.jpeg", alt: "After renovation - Kitchen" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-16-1.jpg.jpeg", alt: "After renovation - Dining area" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-17-1-scaled.jpg.jpeg", alt: "After renovation - Interior detail" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-18.jpg.jpeg", alt: "After renovation - Living space" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-19-scaled.jpg.jpeg", alt: "After renovation - Modern details" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-20-scaled.jpg.jpeg", alt: "After renovation - Light fixtures" },
      { src: "/turn-key-management-amsterdam-apartment-1/Amsteldijk-Duplex-Appartments-21-scaled.jpg.jpeg", alt: "After renovation - Final result" },
    ]
  }
}
  ...
  return (
    <div className="bg-white text-black">
      ...
      <ProjectVideoShowcase 
        videoId="1097920278"
        title="Amsterdam Apartment 1 - Complete Transformation"
        description="Witness the incredible before transformation journey of this historic Amsterdam apartment featuring complete renovation and modern interior design"
      />
          ...
          <div className="mt-16" id="before-gallery">
            <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {projectDetails.beforeSection.images.slice(3, 6).map((image, index) => (
                  <AnimatedElement
                    key={index}
                    animationType="fadeInUp"
                    delay={index * 0.1}
      ...
      <section className="py-12 lg:py-16 bg-white text-black" id="in-progress-section">
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            <div className="space-y-12">
              <div className="grid md:grid-cols-2 gap-8">
                {projectDetails.inProgressSection.images.slice(1, 3).map((image, index) => (
                  <AnimatedElement
                    key={index}
                    animationType="fadeInUp"
                    delay={index * 0.1}
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {projectDetails.inProgressSection.images.slice(3, 5).map((image, index) => (
                  <AnimatedElement
                    key={index}
                    animationType="fadeInUp"
                    delay={index * 0.1}
