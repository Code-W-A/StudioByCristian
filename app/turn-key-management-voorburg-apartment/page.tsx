...
const projectDetails = {
  ...
  heroImage: "/turn-key-management-voorburg-apartment/Voorburg-Banner-scaled.jpg.jpeg",
  beforeAfterComparisons: [
    {
      before: "/turn-key-management-voorburg-apartment/Voorburg-Before-1.jpg.jpeg",
      after: "/turn-key-management-voorburg-apartment/Voorburg-After-01-1-scaled.jpg.jpeg",
      alt: "Living area transformation"
    },
    {
      before: "/turn-key-management-voorburg-apartment/Voorburg-Before-2.jpg.jpeg",
      after: "/turn-key-management-voorburg-apartment/Voorburg-After-02-scaled.jpg.jpeg",
      alt: "Kitchen renovation"
    },
    {
      before: "/turn-key-management-voorburg-apartment/Voorburg-Before-3.jpg.jpeg",
      after: "/turn-key-management-voorburg-apartment/Voorburg-After-03-scaled.jpg.jpeg",
      alt: "Dining area makeover"
    },
    {
      before: "/turn-key-management-voorburg-apartment/Voorburg-Before-4.jpg.jpeg",
      after: "/turn-key-management-voorburg-apartment/Voorburg-After-04-scaled.jpg.jpeg",
  ...
  beforeSection: {
    ...
    images: [
      { src: "/turn-key-management-voorburg-apartment/Voorburg-Before-1.jpg.jpeg", alt: "Before renovation - Room 1" },
      { src: "/turn-key-management-voorburg-apartment/Voorburg-Before-2.jpg.jpeg", alt: "Before renovation - Room 2" },
      { src: "/turn-key-management-voorburg-apartment/Voorburg-Before-3.jpg.jpeg", alt: "Before renovation - Room 3" },
      { src: "/turn-key-management-voorburg-apartment/Voorburg-Before-4.jpg.jpeg", alt: "Before renovation - Room 4" },
    ]
  },
  afterSection: {
    title: "After",
    ...
    images: [
      { src: "/turn-key-management-voorburg-apartment/Voorburg-After-01-1-scaled.jpg.jpeg", alt: "After renovation - Living area" },
      { src: "/turn-key-management-voorburg-apartment/Voorburg-After-02-scaled.jpg.jpeg", alt: "After renovation - Kitchen" },
...
export default function VoorburgApartmentPage() {
  return (
    <div className="bg-white text-black">
      ...
      {/* After Section */}
      <section className="py-12 lg:py-16 bg-white text-black" id="after-section">
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <AnimatedElement animationType="fadeInUp">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              {/* Text Left */}
          ...
          <div className="mt-16">
            <div className="space-y-12">
              ...
              {/* Final large image if available */}
      ...
      <section className="py-12 lg:py-16 bg-gray-50 text-black">
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-16">
            {/* Design Projects - Image Left, Text Right */}
            <AnimatedElement animationType="fadeInUp">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Furniture Production - Text Left, Image Right */}
            <AnimatedElement animationType="fadeInUp" delay={0.2}>
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 lg:order-1">
