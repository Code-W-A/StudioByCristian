...
export default function WassenaarHouseConceptPage() {
  ...
  return (
    <div className="bg-white text-black">
      ...
      {/* Large Dynamic Images Grid - 2 per row then 1 per row pattern */}
      <section className="py-12 lg:py-16 bg-gray-50 text-black">
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          {isMobile ? (
            ...
            // Desktop version with individual animations - 2 per row then 1 per row pattern
            <div className="space-y-12">
              {/* First two images in a grid */}
              <div className="grid md:grid-cols-2 gap-8">
                {projectDetails.gallery.slice(6, 8).map((image, index) => (
                  <AnimatedElement
                    key={index}
              ...
              {projectDetails.gallery.slice(8, 9).length > 0 && (
                <div className="flex justify-center">
                  <AnimatedElement animationType="fadeInUp" delay={0.2}>
                    <div className="relative overflow-hidden rounded-xl shadow-lg bg-gray-100 max-w-4xl w-full">
                      <Image
                        src={projectDetails.gallery[8].src}
                        alt={projectDetails.gallery[8].alt}
                        width={1200}
                        height={675}
                        className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
                  ...
                  return (
                    <div key={`group-${globalIndex}`} className="space-y-12">
                      <div className="grid md:grid-cols-2 gap-8">
                        ...
                        {projectDetails.sliderImages[index + 1] && (
                          <AnimatedElement
                            animationType="fadeInUp"
                            delay={0.2}
                          >
                            <div className="relative overflow-hidden rounded-xl shadow-lg bg-gray-100">
                              <Image
                                src={projectDetails.sliderImages[index + 1].src}
                                alt={projectDetails.sliderImages[index + 1].alt}
                                width={800}
                                height={600}
                                className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
                                style={{ aspectRatio: '4/3' }}
                      ...
                      {projectDetails.sliderImages[index + 2] && (
                        <div className="flex justify-center">
                          <AnimatedElement animationType="fadeInUp" delay={0.3}>
                            <div className="relative overflow-hidden rounded-xl shadow-lg bg-gray-100 max-w-4xl w-full">
                              <Image
                                src={projectDetails.sliderImages[index + 2].src}
                                alt={projectDetails.sliderImages[index + 2].alt}
                                width={1200}
                                height={675}
                                className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
                                style={{ aspectRatio: '16/9' }}
